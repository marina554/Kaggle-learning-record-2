...
To improve generalization, it applies:
- Data augmentation
...
3. Run `train_kaggle.py` (or paste the code into the notebook).
...
Notes
Rank/score can be added here after confirming from Kaggle submission history.

digit-recognizer-ensemble/
├─ README.md
├─ requirements.txt
├─ train_kaggle.py
├─ train_local.py # ローカル用
└─ assets/
└─ (optional) training_curve.png
